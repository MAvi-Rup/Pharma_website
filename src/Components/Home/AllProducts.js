        ...
        <div>
            <div className="container pt-5 mb-5">
                ...
                <div className='row pt-5 pb-5'>
                       {
                        isCompleted != true ?  product.map((product=><div className="col-md-3 pe-2 pb-3"><img onClick={()=>{navigateProduct(product._id)}} src={product.img} width='255px' /> </div>)): allProducts.map((product=><div className="col-md-3 pe-2 pb-3"><img onClick={()=>{navigateProduct(product._id)}} src={product.img} width='255px' /> </div>))
                       }
                       {/* {
