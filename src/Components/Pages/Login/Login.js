...
const Login = () => {
    ...
    return (
        <div className='container w-50'>
            <h1 className='text-center mt-5 mb-5 text-primary'>Please Login</h1>
            ...
            <p className='text-danger fst-italic'>New to Beximco Pharma? <Link to="/register" className='text-dark pe-auto text-decoration-none' onClick={navigateRegister}>Please Register</Link> </p>
